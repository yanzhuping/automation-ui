...
testData1 = readExcel(os.path.join(get_root_path(),'tranderpay_api','api_data', 'SocialSecurityBusinessApplication.xls'))
...
class TestAPI(unittest.TestCase):
    ...
    def tearDownClass(cls):
        pass
    @data(*testData1)
    def test_SocialSecurityBusinessApplication(self,data):
        print(data)
